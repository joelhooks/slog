...
This repo treats dependency, workflow, CLI source, install script, and release changes as security-sensitive.
...
- Require review for `.github/workflows/`, `.github/actions/`, package manifests, lockfiles, `.npmrc`, CLI source, install scripts, and release config.
